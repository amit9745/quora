<template>
    <div class="questions-container">
      <!-- {{ answers1 }} -->
        <div v-for="answer in answers1" :key="answer.id" class="question-header">
 ...
 import {ref} from 'vue';
  ...
  export default {
    setup() {
      ...
      const FETCH_ANSWERS_BY_USER = async () => {
        const apiUrl = apiUrls.getAnswersByUser;
