<template>
    <div class="profile-container">
        ...
        <div class="text-container">
            ...
            <button class="edit" @click="followUser">{{ followText }}</button>
...
import { apiUrls, header } from "../components/apiUrls.js"
...
export default defineComponent({
    ...
    setup() {
        ...
        const followUser = async () => {
            ...
            queryParams.set('followingId', userProfile.value.profileId)
            const apiUrl = apiUrls.followUser;

            const res = await fetch(`${apiUrl}?${queryParams.toString()}`, head)
            const parsedResponse = await res.json()
            // window.location.reload()
            console.log('following', parsedResponse)
